...
const Navbar = () => {
  return (
    <nav className='w-[80%] h-[15vh] flex flex-row justify-center items-center rounded-2xl bg-white text-black shadow-lg z-10 top-3.5'>
        ...
        <div className='w-[40%] h-[99%] flex justify-center items-center'>
            <ul className='w-[60%] h-[99%] flex flex-row justify-start items-center gap-2'>
