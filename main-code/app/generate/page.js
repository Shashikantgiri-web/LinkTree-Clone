...
const generate = () => {
    return (
        <section className='w-full h-auto grid grid-cols-2 items-center gap-2.5 bg-[#e9c0e9] text-[#261d39] overflow-y-scroll scrollbar-hide justify-center' style={{display: 'grid', justifyItems: 'center', alignItems: 'center'}}>
            <div className="w-[80%] h-[77vh] flex flex-col justify-center items-center bg-transparent border-2 border-pink-300 rounded-3xl p-1 gap-2">
                ...
                <div className='w-[99%] h-30 flex flex-col justify-start items-center'>
                    ...
                    <div className="my-4 w-[45%] flex flex-col gap-2.5">
                        <input type="text" placeholder='choose your handle' className='w-[99%] h-15 pl-2.5 rounded-3xl bg-[#00489dd6] text-while focus:ring-pink-400'/>
                    </div>
                </div>
                <div className='w-[99%] h-62.5 flex flex-col justify-start items-center'>
                    <h2 className='text-xl font-semibold'>Step 2: Add Your Links</h2>
                    <div className="my-4 w-[45%] flex flex-col gap-2.5">
                        <input type="text" placeholder='Enter link text' className='w-[99%] h-15 pl-2.5 rounded-3xl bg-[#00489dd6] text-while focus:ring-pink-400'/>
                        <input type="text" placeholder='Enter link' className='w-[99%] h-15 pl-2.5 rounded-3xl bg-[#00489dd6] text-while focus:ring-pink-400'/>
                        <button className='w-[99%] h-15 rounded-3xl bg-pink-400 text-white font-bold hover:bg-pink-500'>+ Add Link</button>
                    </div>
                </div>
                <div className='w-[99%] h-42.5 flex flex-col justify-start items-center'>
                    ...
                    <input type="text" placeholder='Enter picture URL' className='w-[45%] h-15 pl-2.5 rounded-3xl bg-[#00489dd6] text-while focus:ring-pink-400'/>
                </div>
            </div>
